def isSubArrayInside(arr, pat, x, y, pat_y, pat_x):
...
def checkAll(arr, pat, arr_y, arr_x, pat_y, pat_x):
    for y in xrange(arr_y-pat_y+1):
        for x in xrange(arr_x-pat_x+1):
            if isSubArrayInside(arr, pat, x, y, pat_y, pat_x):
                return True
...
if __name__ == '__main__':
    ...
    for _ in xrange(t):
        ...
        if checkAll(arr, pat, arr_y, arr_x, pat_y, pat_x):
            print "YES"
        else:
            print "NO"
